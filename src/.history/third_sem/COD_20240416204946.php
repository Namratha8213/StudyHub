        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='http://localhost/education/download.php?material_id=" . $row['material_id'] . "' onclick=\"return confirm('Are you sure you want to Download this study material?');\">Update</a></td>";
                    echo "</tr>";
                }
            } else {
