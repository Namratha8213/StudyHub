        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='http://localhost/education/updateup.php?material_id=" . $row['material_id'] . "' onclick=\"return confirm('Are you sure you want to update this study material?');\">Delete</a></td>";
                    echo "</tr>";
                }
            } else {
