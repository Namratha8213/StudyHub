...
<body>
    <div class="table-container">
        <table>
            <tr><th>Material ID</th><th>Subject Name</th><th>File Name</th><th>File Path</th><th>Upload Date</th></tr>
            <!-- The rows of the table will be generated dynamically by the PHP code -->
        </table>
    </div>
</body>
</html>
