    ...
    <section className="about_sec">
      <div className="about_box">
        ...
        <p className="about_para">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias vero ut reiciendis, cumque at earum quisquam mollitia iusto ullam, similique recusandae! Dolor labore fuga exercitationem. Distinctio, similique possimus? Pariatur, magnam.
